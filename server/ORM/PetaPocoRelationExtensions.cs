...
namespace PetaPoco
{
    public static class PetaPocoRelationExtensions
    {
        ...
        public static List<T> FetchOneToMany<T, T1>(this Database db, Func<T, object> key, Func<T1, object> manyKey, Sql Sql)
        {
            var relator = new Relator();
        ...
        public static List<T> FetchOneToMany<T, T1>(this Database db, Func<T, object> key, Func<T1, object> manyKey, string sql, params object[] args)
        {
